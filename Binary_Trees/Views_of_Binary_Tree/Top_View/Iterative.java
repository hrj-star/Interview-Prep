...
0 - 5 - dist already present in map , so dont enter
...
0 - 6 - dist already present in map , so dont enter
...
class Iterative{
    ...
    public static void topView(Node root){
        ...
        while(!queue.isEmpty()){
            ...
            if(map.get(tempHd) == null){ // if value does not exists for given hd key , then insert in map
